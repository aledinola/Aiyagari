function par = set_parameters_ACI()

% Calibration Omer Acikgoz Journal of Economic Theory (2018)
...
gamma    = 6.5; % CRRA utility consumption
alpha    = 0.3;% capital coeff Cobb-Douglas
beta     = 0.1; % discount factor
delta    = 1.0;
rho_z    = 0.82;
sigma_z  = 0.29; %st. deviation of AR1 shocks
...
tol_ge   = 1e-10;
maxit_ge = 300;
alg_GE   = 4;  % 1=Brent, 2=Illinois, 3=dampening, 4=draw capital demand and cap supply
...
alg_lin    = 1; % Algorithm to solve large linear system in sub_howard_vec
...
%% Grid for assets
na      = 2000; % No. of points for assets
a_min   = 0;
a_max   = 5;
a_space = 2;
...
nz = 7;
ave_z = 0;
[pi_z,z_grid_logs]=markovapprox(rho_z,sigma_z,ave_z,3.0,nz);
